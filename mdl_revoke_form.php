...
/**
 * OBU Application - Revoke form [Moodle]
 *
...
class mdl_revoke_form extends moodleform {
    function definition() {
        $mform =& $this->_form;
        ...
        $buttonarray = array();
        $buttonarray[] = &$mform->createElement('submit', 'submitbutton', get_string('revoke', 'local_obu_application'));
    ...
    function validation($data, $files) {
        ...
        if ($data['submitbutton'] == get_string('revoke', 'local_obu_application')) {
            if ($data['comment'] == '') {
