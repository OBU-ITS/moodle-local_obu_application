...
// $plugin->version  = 2022011001;   // The (date) version of this module + 2 extra digital for daily versions
$plugin->version  = 2022051001;   // The (date) version of this module + 2 extra digital for daily versions
$plugin->requires = 2015111604;   // Requires this Moodle version - at least 3.0.4
$plugin->cron     = 0;
$plugin->release = 'v2.5.5';
