...
/**
 * OBU Application - List all qualifications [Moodle]
 *
...
$url = $dir . 'mdl_qualification_list.php';
...
if ($qualifications != null) {
    foreach ($qualifications as $qualification) {
        ...
        $table->data[] = array(
            ...
            $qualification->admissions_type,
            $cpd_subset,
            $qualification->crm_dropdown_text,
            $qualification->notes
        );
    }
}
...
if (!isset($_REQUEST['export'])) {
    ...
    $heading = get_string('qualification_list', 'local_obu_application');
    $PAGE->set_url($url);
    ...
    header('Content-Disposition: attachment;filename=qualification_list.csv');
