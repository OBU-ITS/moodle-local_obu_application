...
$string['registration_foot_notice_1'] = 'If you supplied a correct username or unique email address you should receive an email shortly. Please also check your spam folders.';
$string['registration_foot_notice_2'] = 'If your previous account has not been  accessed for one year or more, you may need to get your account reactivated to receive your password reset email.';
$string['registration_foot_notice_3'] = 'If you do not receive your emails, or need to reactivate your account, please email <a href="mailto:HLSCPDadmissions@brookes.ac.uk">HLSCPDadmissions@brookes.ac.uk</a>';
