...
$string['privacy:metadata:local_obu_application:settled_status'] = 'Settled status.';
...
$string['settled_status_preamble'] = 'If your current home address is outside of the UK, please indicate if you already have evidence of \'settled status\' in the UK:';
$string['settled_status'] = 'Settled status?';
