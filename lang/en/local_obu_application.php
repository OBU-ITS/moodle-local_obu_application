...
$string['registration_notice_1'] = 'Fill out your details below.';
$string['registration_notice_2'] = 'An email will be sent to the email address provided below. Please check spam if it does not appear.';
$string['registration_notice_3'] = 'Click on the web link contained in the email, and follow the instructions.';
