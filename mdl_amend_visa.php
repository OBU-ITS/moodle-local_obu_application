...
local_obu_application_unpack_supplement_data($application->visa_data, $current_supplement_data);
...
if ($mform_data = (array)$mform->get_data()) {
    ...
    local_obu_application_write_visa_data_by_id($application->id, local_obu_application_pack_supplement_data($updated_supplement_data));
    redirect($process);
}
