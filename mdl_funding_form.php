...
/**
 * OBU Application - Funding Report options form
 *
...
class mdl_funding_form extends moodleform {
    ...
    function definition() {
		...
		$mform->addElement('html', '<h2>' . get_string('funding_options', 'local_obu_application') . '</h2>');
		...
		// Organisation
		$select = $mform->addElement('select', 'organisation', get_string('organisation', 'local_obu_application'), $data->organisations, null);
